...
const Header = () => {
  ...
  const LARGE_DEVICE_CONTENT = <FlexBox component="nav" sx={LIST_STYLE}>
      ...
      <Box component={Link} href="https://quickframe-doc.vercel.app" color="text.primary">
        Documentation
      </Box>
      ...
      <Drawer anchor="right" open={open} onClose={() => setOpen(false)}>
        <Scrollbar>
          ...
          height: "100%"
            ...
            <ListItem disablePadding>
              <ListItemButton LinkComponent="a" href="https://quickframe-doc.vercel.app">
                Documentation
              </ListItemButton>
            </ListItem>
  ...
  return <FlexBetween component="header" py={2}>
      ...
      <Box display="flex" component={Link} href="/" alignItems="center" gap={0.5}>
        <img src="/static/logo/logo-svg.svg" alt="QuickFrame admin" width={35} height={35} />
      </Box>
