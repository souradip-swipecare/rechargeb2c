...
import { FlexBox, FlexRowAlign } from "@/components/flexbox"; // STYLED COMPONENT
      ...
      <Grid container spacing={3} alignItems="center">
        ...
        <Grid item xl={7} lg={8}>
          ...
          xs: "wrap"
            ...
            <Box alt="about" width="100%" component="img" borderRadius={4} src="/static/cover/about-1.jpg" />
            <Box alt="about" width="100%" component="img" borderRadius={4} src="/static/cover/about-2.jpg" />
          </FlexBox>
        </Grid>
      </Grid>
    </Box>;
